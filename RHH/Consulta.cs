...
namespace RHH
{
    public partial class Consulta : Form
    {
        ...
        public void OcultarColumnas()
        {
            ...
            //dgListado.Columns[56].Visible = false;
        }
        ...
        private void dgListado_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            _info.txtEstudiosInfo.Text = dgListado.CurrentRow.Cells[7].Value.ToString();
            _info.txtGradoInfo.Text = dgListado.CurrentRow.Cells[36].Value.ToString();
            _info.txtIdiomaInfo.Text = dgListado.CurrentRow.Cells[37].Value.ToString();
            _info.txtNombrePinfo.Text = dgListado.CurrentRow.Cells[40].Value.ToString();
            _info.txtNombreMinfo.Text = dgListado.CurrentRow.Cells[43].Value.ToString();
            ...
            _info.txtLugar.Text = dgListado.CurrentRow.Cells[33].Value.ToString();
            _info.txtTermino.Text = dgListado.CurrentRow.Cells[35].Value.ToString();
            ...
            _info.txtEstadoP.Text = dgListado.CurrentRow.Cells[41].Value.ToString();
            _info.txtEstadoM.Text = dgListado.CurrentRow.Cells[44].Value.ToString();
            _info.txtConyugue.Text = dgListado.CurrentRow.Cells[46].Value.ToString();
            _info.txtTelConyugue.Text = dgListado.CurrentRow.Cells[47].Value.ToString();
            _info.txtPersonaEm.Text = dgListado.CurrentRow.Cells[48].Value.ToString();
            _info.txtParentesco.Text = dgListado.CurrentRow.Cells[49].Value.ToString();
            _info.txtTelefonoEm.Text = dgListado.CurrentRow.Cells[50].Value.ToString();
            _info.txtIdAcademicos.Text = dgListado.CurrentRow.Cells[30].Value.ToString();
            _info.txtInstitucionAcademica.Text = dgListado.CurrentRow.Cells[33].Value.ToString();
            _info.txtTelefonoPadre.Text = dgListado.CurrentRow.Cells[42].Value.ToString();
            _info.txtTelefonoMadre.Text = dgListado.CurrentRow.Cells[45].Value.ToString();
            _info.txtIdFamiliares.Text = dgListado.CurrentRow.Cells[38].Value.ToString();
            _info.txtSalario.Text = dgListado.CurrentRow.Cells[26].Value.ToString();
            _info.txtPuesto.Text = dgListado.CurrentRow.Cells[28].Value.ToString();
        ...
        private void dgListado_DataSourceChanged(object sender, EventArgs e)
        {
            //dgListado.DataSource = _consulta.CargarLista();
        }
    }
